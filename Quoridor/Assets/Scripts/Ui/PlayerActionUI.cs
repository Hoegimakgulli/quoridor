...
{
    RectTransform[] playerUIs = new RectTransform[3]; //플레이어용 UI. 0 = 이동. 1 = 건설. 2 = 공격
    Image[] uiImages = new Image[3]; //각 버튼의 이미지
    Image[] uiImages2 = new Image[3]; //각 버튼의 이미지 안의 그림
    RectTransform rt;
    ...
    //UI 클릭 시 애니메이션 연출. 0 = 이동. 1 = 건설. 2 = 공격. 3 = 아무것도 선택하지 않음
