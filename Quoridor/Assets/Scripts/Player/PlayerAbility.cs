...
//         public bool Event()
//         {
//             Vector2Int newGridPosition = GameManager.playerGridPositionList + new Vector2Int(0, -2);
...
//                 if (result[0] || !result[1] || result[2])
//                 {
//                     newGridPosition = GameManager.playerGridPositionList;
//                 }
//                 else
//                 {
//                     newGridPosition = GameManager.playerGridPositionList + new Vector2Int(0, -1);
//                 }
//             }
//             else
//             {
//                 newGridPosition = GameManager.playerGridPositionList + new Vector2Int(0, -2);
//             }


//             thisScript.transform.position = GameManager.ChangeCoord(newGridPosition);
//             GameManager.playerGridPositionList = newGridPosition;
...
//                     {
//                         attackRange.Add(GameManager.ChangeCoord(enemyValues.position) - GameManager.playerGridPositionList);
//                     }
//                     tempPosition = GameManager.playerGridPositionList;
//                 }
//                 if (tempPosition != GameManager.playerGridPositionList) shouldSetRange = true;
//             }
//         }
//     }
...
//         public bool Event()
//         {
//             Enemy targetEnemy = EnemyManager.GetEnemy(GameManager.enemyValueList.OrderBy(enemyValue => (enemyValue.position - GameManager.ChangeCoord(GameManager.playerGridPositionList)).magnitude).ToList()[0].position);
...
//             {
//                 if (EnemyManager.GetEnemy(out Enemy enemy, GameManager.ChangeCoord(GameManager.playerGridPositionList + attackPosition), false) != null)
//                 {
